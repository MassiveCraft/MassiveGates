...
import com.massivecraft.massivegates.privatelistener.alterabs.GateAlterCancelBlockListener;

public class GateAlterCancelContentBlockListener extends GateAlterCancelBlockListener
{
	public GateAlterCancelContentBlockListener(P p)
	{
		super(p);
	}
